...
(() => {
  ...
  function boot(runtime, doc = document) {
    ...
    function StandaloneRoot() {
      ...
      // PATCH (mail-overzicht): props ook uit de query string lezen, zodat de
      // overzichtspagina ?mode=light|dark en ?layout=desktop|mobile kan doorgeven.
      // Alleen props die het design zelf declareert worden overschreven; validatie
      // laten we aan de renderVals() van het design zelf. Zie public/mail-overzicht/README.md
      // — deze regel opnieuw toepassen als support.js uit het designproject wordt bijgewerkt.
      const fromQuery = React.useMemo(() => {
        const o = {};
      ...
      return h(Root, { ...defaults, ...fromQuery, ...entry.propOverrides || {} });
    }
